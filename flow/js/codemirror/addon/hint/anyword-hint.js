...
(function(mod) {
  ...
  CodeMirror.registerHelper("hint", "anyword", function(editor, options) {
    ...
    let defaultWords = ['log','List','return',{text:'if(){}',offset:3},{text:'else{}',offset:1},{text:'else if(){}',offset:3},{text:'while(){\n  \n}',upOffset:2,offset:2},{text:'for(){}',offset:3},'def','break','context','continue','continueInvoke','params','JSON','SqlUtil','FlowUtil','ResultType','SpringUtil','HttpUtil','JsonUtil','throw new RuntimeException("")'];
    let stillHint=false;
