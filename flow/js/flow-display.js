...
function FlowDisplay(diagramDiv) {
    ...
    function init(divId) {
        ...
        _displayer.addDiagramListener("ObjectDoubleClicked", window.onFlowDialogObjectDoubleClicked);
        // 流程步骤的样式模板
    ...
    function makeLinkTemplate(){
        return G(go.Link,
            ...
            G(go.Shape, { isPanelMain: true, stroke: "black", strokeWidth: 2 }, new go.Binding("stroke"),new go.Binding("zOrder")),
            G(go.Shape, { isPanelMain: true, stroke: "gray", strokeWidth: 2 }, new go.Binding("stroke")),
