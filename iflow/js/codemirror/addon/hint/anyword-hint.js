...
(function(mod) {
  ...
  CodeMirror.registerHelper("hint", "anyword", function(editor, options) {
    ...
    aiDotSug('context', [{text:"saveParam('',v)",offset:4},{text:'saveParams([k:v])',offset:4},'suspendFlow()','resultContext','flowBizOrderId',{text:"error('errMsg')",offset:2},'serviceId','groupId','nodeKey','nodeText']);
    aiDotSug('ResultType',['FAIL','PROCESSING','SUCCESS']);
    aiDotSug('SqlUtil',[{text:'list("select * from ",wheres)',offset:9},{text:'map("select * from  where id=:id",[id:1])',offset:22},{text:"object('select count(1) from ',[:],Long.class)",offset:17},{text:"insertByMap('t', fields)",offset:10},{text:"updateByMap('t', fields)",offset:10},{text:"updateByMapPrimaryKey('t',fields,'id')",offset:14},{text:"updateByMap('t',fields,wheres)",offset:16},"update(sql)","update(sql,params)",'startTransaction()','commit()','rollback()','list(sql,wheres,true)','map(sql,wheres,true)',{text:"init(SpringUtil.getBean())",offset:2},{text:"init('dsKey',{})",offset:5},{text:'exeTx({\n  \n})',upOffset:1},{text:"eq(sql,params,'col')",offset:2},{text:"lte(sql,params,'col','key')",offset:8},{text:"gte(sql,params,'col','key')",offset:8},{text:"in(sql,params,'col')",offset:2},{text:"notIn(sql,params,'col')",offset:2},{text:"limit(sql,params)",offset:0}]);
